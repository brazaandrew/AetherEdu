    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'save_201_file':
                ...
                if ($result['success']) {
                    $_SESSION['my201_message'] = 'Your 201 File has been saved successfully!';
                } else {
                    $_SESSION['my201_error'] = 'Error: ' . $result['error'];
                }
                break;
            case 'add_education':
                $data = array_merge(['employee_id' => $employeeId], $_POST);
                $hrController->addEducation($data);
                $_SESSION['my201_message'] = 'Education record added.';
                break;
            case 'add_experience':
                $data = array_merge(['employee_id' => $employeeId], $_POST);
                $hrController->addWorkExperience($data);
                $_SESSION['my201_message'] = 'Work experience added.';
                break;
            case 'add_training':
                $data = array_merge(['employee_id' => $employeeId], $_POST);
                $hrController->addTraining($data);
                $_SESSION['my201_message'] = 'Training record added.';
                break;
        }
    }
    header('Location: my-201-file.php');
    exit;
}
...
$message = $_SESSION['my201_message'] ?? '';
$error = $_SESSION['my201_error'] ?? '';
unset($_SESSION['my201_message'], $_SESSION['my201_error']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="tab-content">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="place_of_birth" class="form-control" value="<?= htmlspecialchars($file['place_of_birth'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="citizenship" class="form-control" value="<?= htmlspecialchars($file['citizenship'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="blood_type" class="form-control" value="<?= htmlspecialchars($file['blood_type'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">GSIS No.</label>
                                        <input type="text" name="gsis_no" class="form-control" value="<?= htmlspecialchars($file['gsis_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">PAG-IBIG No.</label>
                                        <input type="text" name="pagibig_no" class="form-control" value="<?= htmlspecialchars($file['pagibig_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">PhilHealth No.</label>
                                        <input type="text" name="philhealth_no" class="form-control" value="<?= htmlspecialchars($file['philhealth_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">SSS No.</label>
                                        <input type="text" name="sss_no" class="form-control" value="<?= htmlspecialchars($file['sss_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">TIN No.</label>
                                        <input type="text" name="tin_no" class="form-control" value="<?= htmlspecialchars($file['tin_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Agency Employee No.</label>
                                        <input type="text" name="agency_employee_no" class="form-control" value="<?= htmlspecialchars($file['agency_employee_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Residential Address</label>
                                        <textarea name="residential_address" class="form-control" rows="2"><?= htmlspecialchars($file['residential_address'] ?? '') ?></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Permanent Address</label>
                                        <textarea name="permanent_address" class="form-control" rows="2"><?= htmlspecialchars($file['permanent_address'] ?? '') ?></textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Telephone No.</label>
                                        <input type="text" name="telephone_no" class="form-control" value="<?= htmlspecialchars($file['telephone_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Mobile No.</label>
                                        <input type="text" name="mobile_no" class="form-control" value="<?= htmlspecialchars($file['mobile_no'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Email</label>
                                        <input type="email" name="email" class="form-control" value="<?= htmlspecialchars($file['email'] ?? '') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="position_title" class="form-control" value="<?= htmlspecialchars($file['position_title'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Department</label>
                                        <input type="text" name="department" class="form-control" value="<?= htmlspecialchars($file['department'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Salary Grade</label>
                                        <input type="text" name="salary_grade" class="form-control" value="<?= htmlspecialchars($file['salary_grade'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="skills" class="form-control" rows="2"><?= htmlspecialchars($file['skills'] ?? '') ?></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Non-Academic Recognitions</label>
                                        <textarea name="recognitions" class="form-control" rows="2"><?= htmlspecialchars($file['recognitions'] ?? '') ?></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Membership in Organizations</label>
                                        <textarea name="organizations" class="form-control" rows="2"><?= htmlspecialchars($file['organizations'] ?? '') ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="spouse_name" class="form-control" value="<?= htmlspecialchars($file['spouse_name'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Spouse's Occupation</label>
                                        <input type="text" name="spouse_occupation" class="form-control" value="<?= htmlspecialchars($file['spouse_occupation'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Employer/Business Name</label>
                                        <input type="text" name="spouse_employer" class="form-control" value="<?= htmlspecialchars($file['spouse_employer'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Business Address</label>
                                        <textarea name="spouse_business_address" class="form-control" rows="2"><?= htmlspecialchars($file['spouse_business_address'] ?? '') ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="father_name" class="form-control" value="<?= htmlspecialchars($file['father_name'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Father's Occupation</label>
                                        <input type="text" name="father_occupation" class="form-control" value="<?= htmlspecialchars($file['father_occupation'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Mother's Name</label>
                                        <input type="text" name="mother_name" class="form-control" value="<?= htmlspecialchars($file['mother_name'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Mother's Occupation</label>
                                        <input type="text" name="mother_occupation" class="form-control" value="<?= htmlspecialchars($file['mother_occupation'] ?? '') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?delete_education=<?= $ed['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this record?')"><i class="bi bi-trash"></i></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?delete_experience=<?= $exp['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this record?')"><i class="bi bi-trash"></i></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?delete_training=<?= $t['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this record?')"><i class="bi bi-trash"></i></a>
                                            </td>
                                        </tr>
                ...
                <div class="tab-pane fade" id="documents">
                    <div class="card">
                        <div class="card-header bg-white"><h5 class="mb-0">Documents</h5></div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead><tr><th>Document Name</th><th>Type</th><th>Uploaded</th></tr></thead>
                                    <tbody>
                                        ...
                                        <?php endforeach; if (empty($documents)): ?><tr><td colspan="3" class="text-center text-muted">No documents uploaded yet. Contact HR for document uploads.</td></tr><?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="year_graduated" class="form-control" placeholder="e.g. 2018">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Highest Level / Units Earned</label>
                            <input type="text" name="highest_level" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Year Started</label>
                            <input type="text" name="year_started" class="form-control" placeholder="e.g. 2014">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Scholarship / Academic Honors</label>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="department_office" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Monthly Salary</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Gov't Service</label>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.5" name="hours" class="form-control">
                        </div>
                        <div class="mb-3">
