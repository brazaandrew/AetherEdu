...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['title']) || empty($data['author'])) {
        ...
        $result = $libraryController->addBook($data);
        if ($result['success']) {
            header('Location: library.php?success=added');
            exit;
        } else {
            $error = $result['error'];
        }
        ...
        <div class="main-content">
            ...
            <div class="container-fluid py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2><i class="bi bi-book me-2 text-primary"></i>Add New Book</h2>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Book Information</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="publication_year" name="publication_year" min="1800" max="2099">
                            </div>

                            <!-- Category -->
                            <div class="col-md-4">
                                <label for="category" class="form-label">Category</label>
                                <input type="text" class="form-control" id="category" name="category" list="categoryList" placeholder="Select or type new">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="shelf_location" name="shelf_location" placeholder="e.g., A-12-3">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Brief description of the book..."></textarea>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-check-lg me-2"></i>Add Book
                                    </button>
